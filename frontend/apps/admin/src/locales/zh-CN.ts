export default {
  ...
  'menu.tasks': '任务管理',
  'menu.itsm': '服务流程 (ITSM)',
  'menu.itsm.tickets': '工单中心',
  'menu.itsm.ticket.detail': '工单详情',
  'menu.itsm.processDefs': '流程服务目录',
  'menu.titan': '研发交付 (Titan)',
  'menu.titan.projects': '交付项目',
  'menu.titan.apps': '微服务应用',
  'menu.titan.environments': '环境大盘',
  'menu.titan.artifacts': '制品中心',
  'menu.titan.pipelines': '交付流水线',
  'menu.titan.pipeline.detail': '流水线执行详情',
  'menu.titan.clusters': '集群大盘',
  'menu.titan.integrations': '集成管理',
  'menu.users': '用户中心',
  'menu.monitor': '系统监控',
  'menu.org': '组织管理',
  'menu.org.users': '员工管理',
  'menu.org.dept': '部门管理',
  'menu.org.syspost': '岗位管理',
  'menu.org.post': '岗位管理',
  'menu.permission': '权限管理',
  'menu.permission.dept': '部门管理',
  'menu.permission.syspost': '岗位管理',
  'menu.permission.users': '员工管理',
  'menu.permission.roles': '角色管理',
  'menu.permission.menus': '菜单权限',
  'menu.system': '系统配置',
  'menu.system.dept': '部门管理',
  'menu.system.syspost': '岗位管理',
  'menu.system.users': '员工管理',
  'menu.system.roles': '角色管理',
  'menu.system.menus': '菜单权限',
  'menu.system.dicts': '数据字典',
  'menu.system.apis': '接口字典',
  'menu.system.sysnotice': '通知公告',
  'menu.system.config': '参数设置',
  'menu.system.logs': '审计日志',
  'menu.system.online': '在线用户',
  'menu.system.openapi': '接口文档 (OpenAPI)',
  'menu.system.navigation': '网址导航',
