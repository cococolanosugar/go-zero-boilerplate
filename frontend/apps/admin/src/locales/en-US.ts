export default {
  ...
  'menu.itsm': 'ITSM Services',
  'menu.itsm.tickets': 'Ticket Center',
  'menu.itsm.ticket.detail': 'Ticket Detail',
  'menu.itsm.processDefs': 'Process Catalog',
  'menu.titan': 'Titan DevOps',
  'menu.titan.projects': 'Projects',
  'menu.titan.apps': 'Applications',
  'menu.titan.environments': 'Environments',
  'menu.titan.artifacts': 'Artifacts',
  'menu.titan.pipelines': 'Pipelines',
  'menu.titan.pipeline.detail': 'Pipeline Execution Detail',
  'menu.titan.clusters': 'Kubernetes Clusters',
  'menu.titan.integrations': 'Integrations',
  'menu.users': 'User Center',
  'menu.monitor': 'Monitoring',
  'menu.org': 'Organization',
  'menu.org.users': 'Staff Management',
  'menu.org.dept': 'Department',
  'menu.org.syspost': 'Post Management',
  'menu.org.post': 'Post Management',
  'menu.permission': 'Access Control',
  'menu.permission.dept': 'Department',
  'menu.permission.syspost': 'Post Management',
  'menu.permission.users': 'Staff Management',
  'menu.permission.roles': 'Role Management',
  'menu.permission.menus': 'Menu Permissions',
  ...
  'menu.system.navigation': 'Navigation Hub',
