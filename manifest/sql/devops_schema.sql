-- ====================================================================
-- Titan DevOps 研发交付平台核心数据表 DDL
-- ====================================================================

CREATE TABLE `devops_integration` (
...
CREATE TABLE `devops_pipeline_exec` (
  `id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `devops_pipeline_step_exec` (
  `id` bigint NOT NULL AUTO_INCREMENT,
