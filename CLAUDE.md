...
* **离线模式库与工作流**：本地已持久化缓存 [`.agents/skills/zero-skills/`](file:///D:/work/go-zero-demo/.agents/skills/zero-skills/) 与 [`.ai-context/`](file:///D:/work/go-zero-demo/.ai-context/)。Claude 在编写微服务代码时应优先调用此知识库中的最佳实践。
