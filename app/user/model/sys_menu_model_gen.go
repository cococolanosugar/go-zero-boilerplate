...
func (m *defaultSysMenuModel) Insert(ctx context.Context, data *SysMenu) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.ParentId, data.Title, data.Type, data.Path, data.Component, data.PermissionCode, data.Icon, data.Sort, data.Visible, data.Status)
	}, sysMenuIdKey)
	return ret, err
}
...
func (m *defaultSysMenuModel) Update(ctx context.Context, data *SysMenu) error {
	...
	_, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.ParentId, data.Title, data.Type, data.Path, data.Component, data.PermissionCode, data.Icon, data.Sort, data.Visible, data.Status, data.Id)
	}, sysMenuIdKey)
	return err
}
