...
func (m *defaultSysUserModel) Insert(ctx context.Context, data *SysUser) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.DeptId, data.Username, data.Password, data.RealName, data.Mobile, data.Email, data.Avatar, data.Status, data.TokenVersion)
	}, sysUserIdKey, sysUserUsernameKey)
	return ret, err
}
...
func (m *defaultSysUserModel) Update(ctx context.Context, newData *SysUser) error {
	...
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, newData.DeptId, newData.Username, newData.Password, newData.RealName, newData.Mobile, newData.Email, newData.Avatar, newData.Status, newData.TokenVersion, newData.Id)
	}, sysUserIdKey, sysUserUsernameKey)
	return err
}
