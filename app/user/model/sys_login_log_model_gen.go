...
func (m *defaultSysLoginLogModel) Insert(ctx context.Context, data *SysLoginLog) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.Username, data.LoginIp, data.Browser, data.Os, data.Status, data.Msg, data.LoginTime)
	}, sysLoginLogIdKey)
	return ret, err
}
...
func (m *defaultSysLoginLogModel) Update(ctx context.Context, data *SysLoginLog) error {
	...
	_, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.Username, data.LoginIp, data.Browser, data.Os, data.Status, data.Msg, data.LoginTime, data.Id)
	}, sysLoginLogIdKey)
	return err
}
