...
func (m *defaultSysDeptModel) Insert(ctx context.Context, data *SysDept) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.ParentId, data.Ancestors, data.DeptName, data.Sort, data.Leader, data.Phone, data.Status)
	}, sysDeptIdKey)
	return ret, err
}
...
func (m *defaultSysDeptModel) Update(ctx context.Context, data *SysDept) error {
	...
	_, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.ParentId, data.Ancestors, data.DeptName, data.Sort, data.Leader, data.Phone, data.Status, data.Id)
	}, sysDeptIdKey)
	return err
}
