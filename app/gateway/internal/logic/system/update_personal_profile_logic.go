...
func (l *UpdatePersonalProfileLogic) UpdatePersonalProfile(req *types.UpdatePersonalProfileReq) (resp *types.SysEmptyResp, err error) {
	var userId int64
	...
	_, err = l.svcCtx.UserRpc.UpdatePersonalProfile(l.ctx, &userClient.UpdatePersonalProfileRequest{
		UserId:   userId,
