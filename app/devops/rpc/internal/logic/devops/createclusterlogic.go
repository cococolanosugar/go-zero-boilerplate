...
func (l *CreateClusterLogic) CreateCluster(in *devops.CreateClusterReq) (*devops.CreateClusterResp, error) {
	...
	res, err := l.svcCtx.ClusterModel.Insert(l.ctx, &model.DevopsCluster{
		Name:        in.Name,
		Env:         in.Env,
	...
	return &devops.CreateClusterResp{Id: id}, nil
}
